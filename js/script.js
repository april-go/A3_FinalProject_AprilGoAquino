...
var messageSeller = document.getElementById('messageSeller')
messageSeller.addEventListener('show.bs.modal', function (event) {

  var button = event.relatedTarget

  var recipient = button.getAttribute('data-bs-whatever')

  var modalTitle = messageSeller.querySelector('.modal-title')
  var modalBodyInput = messageSeller.querySelector('.modal-body input')
